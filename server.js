...
const SKILL_NAME = 'My Color';
const GET_HERO_MESSAGE = "Here's your color: ";
const HELP_MESSAGE = 'You can say please give me a color, or, you can say exit... What can I help you with?';
...
alexaRouter.post('/mycolor', function(req, res) {
...
function getNewHero() {
  ...
  var welcomeSpeechOutput = 'Welcome to my color<break time="0.3s" />'
  if (!isFisrtTime) {
    welcomeSpeechOutput = '';
  }
